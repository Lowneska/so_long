...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/09/07 22:06:47 by skhali            #+#    #+#             */
/*   Updated: 2022/09/09 20:47:29 by skhali           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	load_exit_item(t_image *image, t_map *map, int width, int height)
{
	...
	if (!image->item)
		destroy_images(image, map, "Mauvais chargement des images.\n", 8);
	image->exit = mlx_xpm_file_to_image(image->mlx, "sprites/exit.xpm", &width,
			&height);
	if (!image->exit)
		destroy_images(image, map, "Mauvais chargement des images.\n", 9);
}
...
{
	image->wall = mlx_xpm_file_to_image(image->mlx, "sprites/wall.xpm", &width,
			&height);
	if (!image->wall)
		destroy_images(image, map, "Mauvais chargement des images.\n", 1);
	...
	if (!image->ground)
		destroy_images(image, map, "Mauvais chargement des images.\n", 2);
	image->player = mlx_xpm_file_to_image(image->mlx, "sprites/boy.xpm", &width,
			&height);
	if (!image->player)
		destroy_images(image, map, "Mauvais chargement des images.\n", 3);
...
static void	load_wall_face(t_image *image, t_map *map, int width, int height)
{
	...
	if (!image->wall_aright)
		destroy_images(image, map, "Mauvais chargement des images.\n", 11);
	image->player_1 = mlx_xpm_file_to_image(image->mlx,
			"sprites/player_1.xpm", &width, &height);
	if (!image->player_1)
		destroy_images(image, map, "Mauvais chargement des images.\n", 12);
	image->player_2 = mlx_xpm_file_to_image(image->mlx,
			"sprites/player_2.xpm", &width, &height);
	if (!image->player_2)
		destroy_images(image, map, "Mauvais chargement des images.\n", 13);
}
...
{
	image->profil_a = mlx_xpm_file_to_image(image->mlx,
			"sprites/profil_a.xpm", &width, &height);
	if (!image->profil_a)
		destroy_images(image, map, "Mauvais chargement des images.\n", 14);
	image->profil_a_1 = mlx_xpm_file_to_image(image->mlx,
			"sprites/profil_a_1.xpm", &width, &height);
	if (!image->profil_a_1)
		destroy_images(image, map, "Mauvais chargement des images.\n", 15);
	image->profil_a_2 = mlx_xpm_file_to_image(image->mlx,
			"sprites/profil_a_2.xpm", &width, &height);
	if (!image->profil_a_2)
		destroy_images(image, map, "Mauvais chargement des images.\n", 16);
	image->profil_b = mlx_xpm_file_to_image(image->mlx,
			"sprites/profil_b.xpm", &width, &height);
	if (!image->profil_b)
		destroy_images(image, map, "Mauvais chargement des images.\n", 17);
	image->profil_b_1 = mlx_xpm_file_to_image(image->mlx,
			"sprites/profil_b_1.xpm", &width, &height);
	if (!image->profil_b_1)
		destroy_images(image, map, "Mauvais chargement des images.\n", 18);
	image->profil_b_2 = mlx_xpm_file_to_image(image->mlx,
			"sprites/profil_b_2.xpm", &width, &height);
	if (!image->profil_b_2)
		destroy_images(image, map, "Mauvais chargement des images.\n", 19);
}
...
void	load_images(t_image *image, t_map *map)
{
	...
	image->back = mlx_xpm_file_to_image(image->mlx, "sprites/back.xpm",
			&width, &height);
	if (!image->back)
		destroy_images(image, map, "Mauvais chargement des images.\n", 20);
	image->back_1 = mlx_xpm_file_to_image(image->mlx, "sprites/back_1.xpm",
			&width, &height);
	if (!image->back_1)
		destroy_images(image, map, "Mauvais chargement des images.\n", 21);
	image->back_2 = mlx_xpm_file_to_image(image->mlx, "sprites/back_2.xpm",
			&width, &height);
	if (!image->back_2)
		destroy_images(image, map, "Mauvais chargement des images.\n", 22);
}
